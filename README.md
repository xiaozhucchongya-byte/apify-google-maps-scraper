...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/apify-google-maps-scraper?style=social)](https://github.com/data-scrape/apify-google-maps-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/apify-google-maps-scraper?style=social)](https://github.com/data-scrape/apify-google-maps-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/apify-google-maps-scraper)](https://github.com/data-scrape/apify-google-maps-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/apify-google-maps-scraper)](https://github.com/data-scrape/apify-google-maps-scraper/blob/main/LICENSE)
...
```bash
pip install git+https://github.com/data-scrape/apify-google-maps-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/apify-google-maps-scraper.git
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/apify-google-maps-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/apify-google-maps-scraper/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/data-scrape/apify-google-maps-scraper?style=social)](https://github.com/data-scrape/apify-google-maps-scraper)
